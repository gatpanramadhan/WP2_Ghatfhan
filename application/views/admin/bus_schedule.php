<div class="content-wrapper">
    <div class="card mt-4">
        <div class="card-header">
            <h2>Manage Bus Schedule <a href="#" data-toggle="modal" data-target="#myModal"
                ...
                <tbody>
                    ...
                    foreach ($schedules as $key => $obj) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url("admin/bus_schedule_edit/" . $obj['id']) ?>"
                                    class="btn btn-info btn sm">Edit</a>
                                <a href="<?php echo base_url("admin/bus_schedule_delete/" . $obj['id']) ?>"
            ...
            <div class="modal-body">
                <form class="database_operation_from" data-url="<?php echo base_url('admin/bus_schedule'); ?>">
                    <div class="form-group">
                        ...
                        <input type="text" name="bus_number" required class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label> Amount </label>
                            <input type="amount" name="amount" required class="form-control"
