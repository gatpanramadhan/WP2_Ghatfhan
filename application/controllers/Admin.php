...
class Admin extends CI_Controller
{
    ...
    {
        parent::__construct();
        if (!$this->session->userdata('adminisession')) {
    ...
    public function update_location($id)
    {
        if ($this->input->method() == 'post') {
            ...
            echo json_encode(array("status" => "true", "message" => "Data Succesfully Updated", "reload" => base_url("admin/locations")));
        } else {
    ...
    //FOR CONNECT BUTTON DELETE TO DATABASE IN SECTION  BUS SCHEDULE
